  ...
  group('ChannelMapper', () {
    group('DTO to Entity', () {
      ...
      test('parses all channel types correctly', () {
        ...
        expect(
          baseDto.copyWith(type: 'voice').toEntity().type,
          ChannelType.voice,
        );
        expect(
          baseDto.copyWith(type: 'video').toEntity().type,
          ChannelType.video,
        );
        expect(
          baseDto.copyWith(type: 'announcement').toEntity().type,
          ChannelType.announcement,
        );
        expect(
          baseDto.copyWith(type: 'unknown').toEntity().type,
          ChannelType.text,
        ); // defaults
      });
    ...
    group('Entity to DTO', () {
      ...
      test('converts all channel type enums correctly', () {
        ...
        expect(
          baseEntity.copyWith(type: ChannelType.voice).toDTO().type,
          'voice',
        );
        expect(
          baseEntity.copyWith(type: ChannelType.video).toDTO().type,
          'video',
        );
        expect(
